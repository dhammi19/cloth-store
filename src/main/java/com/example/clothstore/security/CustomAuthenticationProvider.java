...
public class CustomAuthenticationProvider implements AuthenticationProvider {
    ...
    */
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        Staff staff = staffService.isLoggedIn(userName);

        if (staff != null) {
            boolean isMatchedPassword =  passwordEncoder.matches(password, staff.getStaffPassword());
            ...
            if (isMatchedPassword) {
                ...
                */
                return new UsernamePasswordAuthenticationToken(staff.getStaffId(), staff.getStaffPassword(), new ArrayList<>());
            } else {
                return null;
            }
        } else {
